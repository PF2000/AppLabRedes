        ...
        <div class="col-md-6">
            ...
            <div class="form-horizontal">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="form-group">
                            ...
                            <div class="col-md-10 ">
                                <asp:DropDownList ID="ddlLabs" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlLabs_SelectedIndexChanged" OnDataBound="ddlLabs_DataBound" CssClass="form-control" DataTextField="name" DataValueField="Id"></asp:DropDownList>
                            </div>
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:PlaceHolder runat="server" ID="cphTypes" Visible="true">
                            <div class="form-group">
                ...
                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:PlaceHolder runat="server" ID="cphPods" Visible="true">
                            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-horizontal">
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:PlaceHolder runat="server" ID="cphUsers" Visible="true">
                            <div class="form-group">
